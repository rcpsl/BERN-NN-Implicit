...
class VNNLib_parser():
    ...
    def read_statements(self, vnnlib_filename):
    ...
    def update_rv_tuple(self, rv_tuple, op, first, second, num_inputs, num_outputs):
    ...
    def make_input_box_dict(self, num_inputs):
    ...
    def read_vnnlib_simple(self,vnnlib_filename, num_inputs, num_outputs):
        ...
        rv.append((self.make_input_box_dict(num_inputs), [], []))
        
        lines = self.read_statements(vnnlib_filename)
        ...
        for line in lines:
            ...
            if groups:
                ...
                for rv_tuple in rv:
                    self.update_rv_tuple(rv_tuple, op, first, second, num_inputs, num_outputs)
            ...
            for rv_tuple in old_rv:
                for c in conjuncts:
                    ...
                    for i in range(count):
                        ...
                        self.update_rv_tuple(rv_tuple_copy, op, first, second, num_inputs, num_outputs)
